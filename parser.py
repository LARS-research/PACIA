...
def get_parser(root_dir='.'):
    ...
    parser.add_argument('--inner_update_step', type=int, default=0)  # 10
    ...
    parser.add_argument("--rel-layer", type=int, default=5, help="number of layers for relation net")
    ...
    parser.add_argument("--adc", type=int, default=0)#0:mlp 1:euclid
    parser.add_argument("--resume", type=int, default=0)
    parser.add_argument("--eid", type=int, default=0)
    parser.add_argument("--fst", type=int, default=0,help='')
    return parser
...
def get_args(root_dir='.',is_save=True):
    ...
    args.rel_k= args.n_shot_train#-1
    if args.pretrained:
        args.enc_layer = 5
        args.emb_dim =300
        args.dropout = 0.5 

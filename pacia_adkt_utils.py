...
from fs_mol.models.pacia_adkt import PACIA_ADKTModel, PACIA_ADKTModelConfig
...
class PACIA_ADKTModelTrainerConfig(PACIA_ADKTModelConfig):
    batch_size: int = 256
...
def validate_by_finetuning_on_tasks(
    ...
    """
    Validation function for PACIA_ADKTModel. Similar to test function;
...
class PACIA_ADKTModelTrainer(PACIA_ADKTModel):
    def __init__(self, config: PACIA_ADKTModelTrainerConfig):
    ...
    def build_from_model_file(
        ...
        model = PACIA_ADKTModelTrainer(config)
